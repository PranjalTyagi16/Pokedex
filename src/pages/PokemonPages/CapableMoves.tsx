    ...
    return (
      <div className="capable-moves">
        ...
        <ul className="capable-moves-list ability">
            {
                pokemonData?.pokemonAbilities?.abilities?.map((ability:string)=>(<li key={ability} className="move">{ability}
        ...
        <ul className="capable-moves-list">
            {
                pokemonData?.pokemonAbilities?.moves?.map((move:string)=>(<li key={move} className="move">{move}
